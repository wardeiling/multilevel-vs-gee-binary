\begin{center}
    \captionof{figure}{Within- and Between-Person Effects of Dichotomous Predictor and Continuous Outcome}
...
\begin{tikzpicture}[scale=1.2]
    ...
    \foreach \shift in {0.2, 0.4, 0.6, 0.8} {
        ...
        % Add dots at X = 0 and X = 1
        \addplot[gray, only marks, mark=*] coordinates {(0, 1.3 - \shift)};
        \addplot[gray, only marks, mark=*] coordinates {(1, 1.3 - \shift + \slopeW)};
